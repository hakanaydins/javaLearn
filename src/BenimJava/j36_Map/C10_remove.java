...
public class C10_remove {
    public static void main(String[] args) {
        ...
        //map.remove();--> Girilen entry mapde varsa siler ve true return eder yoksa false return eder.
        ...
        System.out.println("hm.remove(\"Gabık\",\"ebik\") = " + hm.remove("Gabık", "ebik"));//false
